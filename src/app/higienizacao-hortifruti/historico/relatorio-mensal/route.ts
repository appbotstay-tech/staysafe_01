...
export async function GET(request: NextRequest) {
  ...
  const report: MonthlySanitaryReport = {
    ...
    generatedAtSentence: formatGeneratedAtSentence(generatedAt),
    summaryItems: [
    ...
    digitalSignature: monthlyClosure
      ? {
          name: monthlyClosure.usuarioNomeSnapshot,
          role: getRoleLabel(monthlyClosure.usuarioPerfilSnapshot as UserRole),
          signedAt: formatAppDateTime(monthlyClosure.assinadoEm),
          observation: monthlyClosure.observacao
        }
      : null,
    columns: [
      { key: "data", label: "Data" },
